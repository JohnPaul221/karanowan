...
Tabulation System for karanowan Street Dancing Competition
...
5. Inside [phpMyAdmin](http://localhost/phpmyadmin),
   create a MySQL database named `karanowan` and import [karanowan.sql](bowa-bowaan.sql) into it.
...
9. Open your web browser and access <http://localhost:5184/karanowan/> to view the application.
